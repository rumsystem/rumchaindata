...
type Ready struct {
	...
	RootHash       []byte `protobuf:"bytes,1,opt,name=RootHash,proto3" json:"RootHash,omitempty"`
	ProoferPubkey  string `protobuf:"bytes,2,opt,name=ProoferPubkey,proto3" json:"ProoferPubkey,omitempty"`
...
func (x *Ready) GetProoferPubkey() string {
	if x != nil {
...
var file_chain_proto_rawDesc = []byte{
	...
	0x79, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x50, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x65,
	...
	0x65, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x50, 0x72, 0x6f, 0x6f, 0x66, 0x65,
